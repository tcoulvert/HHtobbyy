...
def main(dfdataset: DFDataset):
    ...
    cat = Categorization(dfdataset, {"discriminator": "SnT4D", "method_options": {'step_size': 0.005, 'patience': 1}, "min_nonres_sideband": 10., "n_cats": 3, "maximization_func": "fom_zscore"})
    cat.run()
